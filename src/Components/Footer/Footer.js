...
const Footer = () => {
    return (
        <div className='main'>
            <section className='hero-section-12'>
                <div className=' container container-md'>
                    <div className='Footer'>
                            <div>
                                <svg className='footer-logo' xmlns="http://www.w3.org/2000/svg" width="197" height="203" viewBox="0 0 197 203" fill="none">
                            ...
                            <div className='footer-fast-part'>
                            ...
                            <div className='footer-ancor footer-fast-part'>
            ...
            <section className='hero-section-13'>
                <div className=' container container-md'>
                    <div className='copyright'>
                        ...
                        <div>
                            <p>2023 © HYDRA LANDING PAGE - BY BISHAL. ALL RIGHTS RESERVED </p>
                        </div>
                    </div>
                </div>
            </section>
